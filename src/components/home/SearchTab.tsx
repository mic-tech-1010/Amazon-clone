    ...
    return (
        <search className="flex-1">
            <form id="search-form" className="flex h-10 w-full rounded-sm" role="search">
                ...
                <Button type="submit" aria-label="search" className="focus:outline-solid! focus:outline-offset-1! focus:outline-white! focus:outline-1 cursor-pointer h-full p-2 bg-[hsl(34,88%,62%)] hover:bg-[hsl(34,88%,62%)] rounded-l-none rounded-r-sm">
